...
export const MockDb: Person[] = [
        {Id: 1, FullName: 'Person A', Weights: [
         ...
         {Id: 2, FullName: 'Person B', Weights: [
            ...
            { Id: 2, Kg: 67, Date: new Date('2017-01-31'), PersonId: 2 },
            { Id: 3, Kg: 65, Date: new Date('2017-01-31'), PersonId: 2 },
            {Id: 4, Kg: 65, Date: new Date('2017-01-31'), PersonId: 2},
            {Id: 5, Kg: 66, Date: new Date('2017-01-31'), PersonId: 2},
            {Id: 6, Kg: 65, Date: new Date('2017-01-31'), PersonId: 2},
            {Id: 7, Kg: 66, Date: new Date('2017-01-31'), PersonId: 2},
            {Id: 8, Kg: 63, Date: new Date('2017-01-31'), PersonId: 2},
            {Id: 9, Kg: 62, Date: new Date('2017-01-31'), PersonId: 2},
            {Id: 10, Kg: 64, Date: new Date('2017-01-31'), PersonId: 2},
            {Id: 11, Kg: 61, Date: new Date('2017-01-31'), PersonId: 2},
            {Id: 12, Kg: 61, Date: new Date('2017-01-31'), PersonId: 2}
        ]}
];
